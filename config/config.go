...
func Load() Config {
	...
	cfg.PostgresDatabase = cast.ToString(getOrReturnDefault("POSTGRES_DATABASE", "project"))
	...
	cfg.ServiceName = cast.ToString(getOrReturnDefault("SERVICE_NAME", "User_api_gateway"))
